...
int non_solid_textures[] = { 0,  1,  2,  3,  4,  5,
                            16, 17, 18, 19, 20, 21,
                            32, 33, 34, 35, 36, 37,
                             7,  8, 48, 49, 50, 83, 84, 90, 91,
                            12, 13, 14, 28, 29, 31, 44, 45, 62,
                           112,113,114,128,130,160,161,162,
                           133,150
};
...
bool Map::is_solid(glm::vec3 position, float *penetration_x, float *penetration_y)
{
    ...
    *penetration_y = 0;
    ...
    for (size_t i = 0; i < sizeof(non_solid_textures) / sizeof(non_solid_textures[0]); i++){
        if (tile == non_solid_textures[i]) return false;
    }
